...
def calculate_p_values(df: pd.DataFrame,
                       ...
                       test_categorical: Optional[str] = 'chi2') -> pd.DataFrame:
    """
            ...
            if column in categorical_columns:
                ...
                if test_categorical == 'fisher':
                    if contingency_table.shape == (2, 2):
                        ...
                        p_value = np.nan  # Fisher's exact only works for 2x2
                ...
                group_0 = df[df[outcome_column] == 0][column].dropna()
                group_1 = df[df[outcome_column] == 1][column].dropna()
                ...
                if test_numeric == 'ttest':
                    ...
                    raise ValueError("Invalid test for numeric features. Choose 'ttest' or 'wilcox'.")
            else:
                raise ValueError(f"Feature '{column}' is neither numeric nor listed in categorical_columns.")
